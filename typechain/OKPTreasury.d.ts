...
interface OKPTreasuryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "repayDebtWithOKP(uint256)": FunctionFragment;
    ...
    "sOKPQueue()": FunctionFragment;
    "setAuthority(address)": FunctionFragment;
    "setNeededQueueBlock(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "repayDebtWithOKP",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "sOKPQueue", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "setAuthority",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "setNeededQueueBlock",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "sOKPQueue", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setAuthority",
    data: BytesLike
  ): Result;
...
export class OKPTreasury extends BaseContract {
  ...
  interface: OKPTreasuryInterface;
  ...
  functions: {
    ...
    sOKPQueue(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    sOKPQueue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
