...
export class OkapiAuthority__factory extends ContractFactory {
  constructor(
  ...
  attach(address: string): OkapiAuthority {
    return super.attach(address) as OkapiAuthority;
  }
  connect(signer: Signer): OkapiAuthority__factory {
    return super.connect(signer) as OkapiAuthority__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): OkapiAuthorityInterface {
    return new utils.Interface(_abi) as OkapiAuthorityInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OkapiAuthority {
    return new Contract(address, _abi, signerOrProvider) as OkapiAuthority;
  }
}
